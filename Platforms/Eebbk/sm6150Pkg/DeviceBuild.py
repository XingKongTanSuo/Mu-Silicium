...
class CommonPlatform ():
    PackagesSupported = ("sm6150Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('sm6150', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "sm6150", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "sm6150Pkg/sm6150.dsc", "Platform Hardcoded")
